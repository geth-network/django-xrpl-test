...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='currency',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='xrpl_app.currency'),
        ),
        migrations.AddField(
            model_name='assetinfo',
            name='issuer',
        ...
        migrations.AddConstraint(
            model_name='assetinfo',
            constraint=models.UniqueConstraint(fields=('issuer', 'currency'), name='unique_asset_issuer_currency'),
        ),
    ]
